 ...
 */
export function createAction(id: NamespacedString, options: ActionOptions): Action {
 ...
 */
export function createNumSlider(id: NamespacedString, options: NumSliderOptions): NumSlider {
